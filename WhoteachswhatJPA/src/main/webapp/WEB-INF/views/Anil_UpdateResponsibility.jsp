...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Update Responsibility</title>
...
<script>
   ...
   */
    ...
    var validateUpdateResponsibilityType= function() {
       	$.post("ajaxUpdateResponsibilty",{ responsibility_type: document.getElementById("responsibility_type").value })
       		.done(function(data) {
    ...
    <ul class="xbreadcrumbs">
		...
		<li>
			<a href="Anil_ManageResponsibilities.html">Manage Responsibilities</a>
		</li>
        <li class="current">
            <a href="Anil_AccessList.html">Update</a>
        </li>
    </ul>
</div>            <header>
                <i class="icon-big-notepad"></i>
                <h2><small>Update Responsibility</small></h2>
                <h3><small>Modify a responsibility</small></h3>
            </header>
             <form method="post" action="ajaxUpdateResponsibilty" id="AddResponsibilityTypeForm" 
            	onsubmit="return validateUpdateResponsibilityType();" class="form-horizontal">
					...
					<div class="span3">
						<div class="controls">
							<input id="responsibility_type" type="text" 
								placeholder="This field will be autoloaded"
