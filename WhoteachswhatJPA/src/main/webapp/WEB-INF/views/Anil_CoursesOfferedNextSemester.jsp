...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Courses Offered Next Semester - Report</title>
...
<script>
    ...
    <ul class="xbreadcrumbs">
        ...
        <li class="current">
            <a href="Anil_CoursesOfferedNextSemester.html">Courses Offered Next Semester</a>
        </li>
    </ul>
</div>            <header>
                <i class="icon-big-notepad"></i>
                <h2><small>Courses Offered Next Semester <b>( Winter 2014 )</b></small></h2>
                <h3><small>See the courses offered in the upcoming semester</small></h3>
            </header>
			...
			<!-- START OF NEW CONTENT -->
				<!--Sortable Non-responsive Table begin-->
					...
					<label style="float: right"><a class="bootstrap-tooltip" data-original-title="Print All" data-placement="top" href="#"><i class="icon-print"></i>Print</a></label>
					<br/>
					<style type="text/css">
						td.align {
					...
					<div id="Input_Field_with_Placeholder" class="control-group row-fluid">
						<div class="span1">
							<label class="control-label" for="programName">CPA</label>
						</div>
					</div>
						...
						<div class="span12">
						   <table class="table table-striped" id="tableSortable">
							   ...
							   <tbody>
								   <tr>
										<td class="align">1</td>
										<td><label><a href="#">IPC144</a></label></td>
										<td class="align">
								   ...
								   <tr>
										<td class="align">2</td>
										<td><label><a href="#">DBS201</a></label></td>
										<td class="align">
								   ...
								   <tr>
										<td class="align">3</td>
										<td><label><a href="#">INT322</a></label></td>
										<td class="align">
								   ...
								   <tr>
										<td class="align">4</td>
										<td><label><a href="#">DCN455</a></label></td>
										<td class="align">
								   ...
								   <tr>
										<td class="align">5</td>
										<td><label><a href="#">PRJ566</a></label></td>
										<td class="align">
								   ...
								   <tr>
										<td class="align">5</td>
										<td><label><a href="#">OOP344</a></label></td>
										<td class="align">
