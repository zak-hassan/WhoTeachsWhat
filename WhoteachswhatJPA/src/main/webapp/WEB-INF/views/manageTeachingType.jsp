...
<script type="text/javascript" src="views_ajax_requests/manageTeachingTypeAJAX.js"></script>
    </head>
...
<script>
    ...
    <ul class="xbreadcrumbs">
									...
									<tr>
										...
										<td class="align">
											...
											<a class="bootstrap-tooltip" data-original-title="Delete" 
												onclick="deleteForm('${tt.getTeachingType_id() }', 
													'${tt.getTeachingType_name() }')"
						...
						<form role="form" id="addTeachingTypeForm" class="form-horizonatal">
							...
							<div class="input-group">
								<span class="input-group-addon">Teaching Type Name </span><br /> <input
									type="text" class="form-control" name="Teaching Type" id="teachingType_name"
									placeholder="Name" />
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form role="form" id="updateTeachingTypeForm" class="form-horizonatal">
							<div class="input-group">
								<input type="hidden" class="form-control" id="up_teachingType_id" name="Teachiing Type id" />
							</div>
							
							<div class="input-group">
								<span class="input-group-addon">Teaching Type Name </span><br /> <input
									type="text" class="form-control" name="Teaching Type" id="up_teachingType_name"
									placeholder="Name" />
							</div>
							<button type="button" class="btn btn-default"
								data-dismiss="modal">Close</button>
		...
		<div id="deleteModal" class="modal hide fade">
			<input type="hidden" id="del_teachingTypeId" name="Teaching Type id" />
			<input type="hidden" id="del_teachingTypeName" />
            <div class="modal-header">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:;" class="btn btn-primary" data-dismiss="modal"
                	onclick="deleteTeachingType()">Yes</a>
            </div>
        </div>
