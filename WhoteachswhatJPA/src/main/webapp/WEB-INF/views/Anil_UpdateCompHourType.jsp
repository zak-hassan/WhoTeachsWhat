...
<script>
   ...
   */
    ...
    var validateUpdateCompHourType= function() {
       	$.post("ajaxUpdateCompHourType",{ faculty_first_name: document.getElementById("comp_hour_type").value })
       		.done(function(data) {
    ...
    <ul class="xbreadcrumbs">
		...
		<li>
			<a href="Anil_ManageCompHours.html">Manage Complimentary Hours</a>
		</li>
        <li class="current">
            <a href="Anil_UpdateCompHourType.html">Update</a>
                ...
                <h2><small>Update Complimentary Hour Type</small></h2>
                <h3><small>Modify complimentary hour type</small></h3>
            </header>
            <form method="post" action="ajaxUpdateCompHourType" id="UpdateCompHourTypeForm" 
            	onsubmit="return validateUpdateCompHourType();" class="form-horizontal">
			...
			<!-- START OF NEW CONTENT -->
				...
				<div id="Input_Field_with_Placeholder" class="control-group row-fluid">
						<div class="span2">
							<label class="control-label" for="comp_hour_type">Complimentary Hour Type</label>
						</div>
						<div class="span3">
							<div class="controls">
