    ...
    <ul class="xbreadcrumbs">
        ...
        <li class="current">
            ...
            <header>
                ...
                <h2><small>Update Program</small></h2>
                <h3><small>Update already existing program.</small></h3>
            </header>
            <form class="form-horizontal">
                <div class="container-fluid">
                    ...
                    <div class="control-group row-fluid">
                        ...
                        <div class="span9">
                            <div class="controls">
                                <input id="course_code" type="text" name="course_code" value="CPA" />
                            </div>
                        </div>
                    </div>
                    <div class="control-group row-fluid">
                        ...
                        <div class="span9">
                            <div class="controls">
                                <input id="course_name" type="text" name="course_name" value="Computer Programming &amp; Analysis" />
                            </div>
                        </div>
                    </div>
                    <div class="control-group row-fluid">
                    ...
                    <div id="Dual_Multi_Select_with_Filter_Search" class="control-group row-fluid">
                        <div class="span3">
                            ...
                            <br />
                            <div class="controls">
                                <input id="course_name" type="text" name="course_name" value="Semester 1" />
                            </div>
                        </div>
                        <div class="span9">
                            <div class="controls">
                                <select multiple name="dualMultiSem1" id="dualMultiSem1">
                                    <option selected="" value="ULIA1010">ULIA1010</option>
                                    <option selected="" value="IOSA1100">IOSA1100</option>
                                    <option selected="" value="IPCA1440">IPCA1440</option>
                    ...
                    <div id="Dual_Multi_Select_with_Filter_Search" class="control-group row-fluid">
                        <div class="span3">
                            ...
                            <br />
                            <div class="controls">
                                <input id="course_name" type="text" name="course_name" value="Semester 2" />
                            </div>
                        </div>
                        <div class="span9">
                            <div class="controls">
                                <select multiple name="dualMultiSem2" id="dualMultiSem2">
                                    ...
                                    <option selected="" value="IBCA2330">IBCA2330</option>
                                    <option selected="" value="OOPA2440">OOPA2440</option>
                                    <option selected="" value="INTA2220">INTA2220</option>
                                    <option selected="" value="DBSA2010">DBSA2010</option>
                                    <option value="DBSA3010">DBSA3010</option>
                                    <option value="INTA3220">INTA3220</option>
                                    <option value="SYSA3660">SYSA3660</option>
                                    <option value="OOPA3440">OOPA3440</option>
                    ...
                    <div id="Dual_Multi_Select_with_Filter_Search" class="control-group row-fluid">
                        <div class="span3">
                            ...
                            <br />
                            <div class="controls">
                                <input id="course_name" type="text" name="course_name" value="Semester 3" />
                            </div>
                        </div>
                        <div class="span9">
                            <div class="controls">
                                <select multiple name="dualMultiSem3" id="dualMultiSem3">
                                    ...
                                    <option value="INTA2220">INTA2220</option>
                                    <option value="DBSA2010">DBSA2010</option>
                                    <option selected="" value="DBSA3010">DBSA3010</option>
                                    <option selected="" value="INTA3220">INTA3220</option>
                                    <option selected="" value="SYSA3660">SYSA3660</option>
                                    <option selected="" value="OOPA3440">OOPA3440</option>
                                    <option value="DCNA4550">DCNA4550</option>
                                    <option value="INTA4220">INTA4220</option>
                                    <option value="SYSA4660">SYSA4660</option>
                                    <option value="JACA4440">JACA4440</option>
                    ...
                    <div id="Dual_Multi_Select_with_Filter_Search" class="control-group row-fluid">
                        <div class="span3">
                            ...
                            <br />
                            <div class="controls">
                                <input id="course_name" type="text" name="course_name" value="Semester 4" />
                            </div>
                        </div>
                        <div class="span9">
                            <div class="controls">
                                <select multiple name="dualMultiSem4" id="dualMultiSem4">
                                    ...
                                    <option value="SYSA3660">SYSA3660</option>
                                    <option value="OOPA3440">OOPA3440</option>
                                    <option selected="" value="DCNA4550">DCNA4550</option>
                                    <option selected="" value="INTA4220">INTA4220</option>
                                    <option selected="" value="SYSA4660">SYSA4660</option>
                                    <option selected="" value="JACA4440">JACA4440</option>
                                    <option value="PRJA5660">PRJA5660</option>
                                    <option value="PRJA6660">PRJA6660</option>
                                    <option value="BACA3440">BACA3440</option>
                                    <option value="DBAA6250">DBAA6250</option>
                    ...
                    <div id="Dual_Multi_Select_with_Filter_Search" class="control-group row-fluid">
                        <div class="span3">
                            ...
                            <br />
                            <div class="controls">
                                <input id="course_name" type="text" name="course_name" value="Semester 5" />
                            </div>
                        </div>
                        <div class="span9">
                            <div class="controls">
                                <select multiple name="dualMultiSem5" id="dualMultiSem5">
                                    ...
                                    <option value="SYSA4660">SYSA4660</option>
                                    <option value="JACA4440">JACA4440</option>
                                    <option selected="" value="PRJA5660">PRJA5660</option>
                                    <option value="PRJA6660">PRJA6660</option>
                                    <option value="BACA3440">BACA3440</option>
                                    <option value="DBAA6250">DBAA6250</option>
                                    <option value="DBDA5250">DBDA5250</option>
                    ...
                    <div id="Dual_Multi_Select_with_Filter_Search" class="control-group row-fluid">
                        <div class="span3">
                            ...
                            <br />
                            <div class="controls">
                                <input id="course_name" type="text" name="course_name" value="Semester 6" />
                            </div>
                        </div>
                        <div class="span9">
                            <div class="controls">
                                <select multiple name="dualMultiSem6" id="dualMultiSem6">
                                    ...
                                    <option value="JACA4440">JACA4440</option>
                                    <option value="PRJA5660">PRJA5660</option>
                                    <option selected="" value="PRJA6660">PRJA6660</option>
                                    <option value="BACA3440">BACA3440</option>
                                    <option value="DBAA6250">DBAA6250</option>
                                    <option value="DBDA5250">DBDA5250</option>
                                    <option value="DBJA5650">DBJA5650</option>
                    ...
                    <div id="Dual_Multi_Select_with_Filter_Search" class="control-group row-fluid">
                        <div class="span3">
                            ...
                            <br />
                            <div class="controls">
                                <input id="course_name" type="text" name="course_name" value="Professional Options" />
                            </div>
                        </div>
                        <div class="span9">
                            <div class="controls">
                                <select multiple name="dualMultiProf" id="dualMultiProf">
                                    ...
                                    <option value="PRJA5660">PRJA5660</option>
                                    <option value="PRJA6660">PRJA6660</option>
                                    <option selected="" value="BACA3440">BACA3440</option>
                                    <option selected="" value="DBAA6250">DBAA6250</option>
                                    <option selected="" value="DBDA5250">DBDA5250</option>
                                    <option selected="" value="DBJA5650">DBJA5650</option>
                                    <option selected="" value="DBLA6260">DBLA6260</option>
                                    <option selected="" value="DBSA5010">DBSA5010</option>
                                    <option selected="" value="DBTA5440">DBTA5440</option>
                                    <option selected="" value="DBWA6240">DBWA6240</option>
                                    <option selected="" value="DOMA5450">DOMA5450</option>
                                    <option selected="" value="DSAA5550">DSAA5550</option>
                                    <option selected="" value="EJBA6050">EJBA6050</option>
                                    <option selected="" value="GAMA5310">GAMA5310</option>
                                    <option selected="" value="GAMA5320">GAMA5320</option>
                                    <option selected="" value="GAMA5360">GAMA5360</option>
                                    <option selected="" value="GAMA5370">GAMA5370</option>
                                    <option selected="" value="GPUA6100">GPUA6100</option>
                                    <option selected="" value="GPUA6210">GPUA6210</option>
                                    <option selected="" value="GUIA5460">GUIA5460</option>
                                    <option selected="" value="ISPA6060">ISPA6060</option>
                                    <option selected="" value="MAPA5230">MAPA5230</option>
                                    <option selected="" value="MAPA5240">MAPA5240</option>
                                    <option selected="" value="MCLA5440">MCLA5440</option>
                                    <option selected="" value="NETA6050">NETA6050</option>
                                    <option selected="" value="OSDA6000">OSDA6000</option>
                                    <option selected="" value="OSDA7000">OSDA7000</option>
                                    <option selected="" value="OOPA3440">DSAA5550</option>
                                    <option selected="" value="PROA6080">PROA6080</option>
                                    <option selected="" value="RPGA5440">RPGA5440</option>
                                    <option selected="" value="SPOA6000">SPOA6000</option>
                                    <option selected="" value="UNXA5100">UNXA5100</option>
                                    <option selected="" value="UNXA5110">UNXA5110</option>
                                    <option selected="" value="VBAA5440">VBAA5440</option>
                                    <option selected="" value="WINA2100">WINA2100</option>
                                    <option selected="" value="WSAA5000">WSAA5000</option>
