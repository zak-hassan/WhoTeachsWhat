...
<script>
   ...
   */
   ...
   var validateNewUser= function() {
   	$.post("ajaxAddUser",{ userId: document.getElementById("userId").value })
   		.done(function(data) {
    ...
    <ul class="xbreadcrumbs">
		...
		<li class="current">
			<a href="Anil_ManageUsers.html">Manage Users</a>
                ...
                <h2><small>Manage Users</small></h2>
                <h3><small>Add, Delete and Suspend users</small></h3>
            </header>
            <form method="post" action="ajaxAddUser" id="ManageUsersForm" onsubmit="return validateNewUser();"
				...
				<!-- http://getbootstrap.com/components/ -->
						...
						<div class="span12">
						   <table class="table table-striped" id="tableSortable">
							   ...
							   <tbody>
								   <tr>
										<td>1</td>
										<td><label><a href="#">Mary-Lynn</a></label></td>
										<td class="align">
											<a href="#">Suspend</a> |
											<a href="#">Delete</a> |
								   ...
								   <tr>
										<td>3</td>
										<td><label><a href="#">Anil</a></label></td>
										<td class="align">
											<a href="#">Suspend</a> |
											<a href="">Delete</a> |
											<a href="Anil_AccessList.html">Permissions</a>
				   ...
				   <!--Sortable Non-responsive Table end-->
					...
					<div id="Input_Field_with_Placeholder" class="control-group row-fluid">
                        <div class="span1">
                            <label class="control-label" for="userId">New User</label>
						</div>
                        <div class="span3">
							<div class="controls">
								<input id="userId" type="text" 
									placeholder="Enter new user to add to the system (using Seneca ID)."
									name="userId" />
                            </div>
                        </div>
