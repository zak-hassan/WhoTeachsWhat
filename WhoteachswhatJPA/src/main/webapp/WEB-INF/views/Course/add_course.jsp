...
<div class="panel">
    <div class="panel-content filler">
        ...
        <div class="panel-search container-fluid">
            ...
            @Purpose: AJAX posting and validation for adding a course
    ...
    <ul class="xbreadcrumbs">
        ...
        <li class="current">
            ...
            <header>
                ...
                <h3><small>Register a new course.</small></h3>
            </header>
            <form method="post" action="ajaxAddCourse" id="AddCourseForm" onsubmit="return validateAddCourse();"
                ...
                <div class="container-fluid">
                    ...
                    <div class="control-group row-fluid">
                        ...
                        <div class="span9">
                            <div class="controls">
                                <input id="reference_input" type="text" name="reference_input" />
                            </div>
                        </div>
                        <!--Input Field with Auto Complete Script-->
                        <script>
                ...
                <div class="row-fluid">
                    <div class="span2 offset4">
                        <button type="submit" class="btn btn-large btn-block btn-info">Add</button>
                    </div>
                    <div class="span2">
