		...
		var validateNewFaculty = function() {
			$
					.post(
							"api/faculty",
							{
								faculty_first_name : document
										.getElementById("fname").value,
								faculty_last_name : document
										.getElementById("lname").value,
								faculty_status : document
										.getElementById("status").selectedIndex + 1
							}).done(function(data) {
	...
	<div class="wrapper">
		...
		<div class="breadcrumb-container" style="width: 100%">
			<ul class="xbreadcrumbs">
				...
				<li><a href="#" class="span1">Faculty</a></li>
				<li class="current"><a href="javascript:;" class="span1">View</a>
				</li>
			</ul>
			<div style="position: absolute; right: 0px;">
				<span><i class="icon-photon user"></i> Mary-Lynn Manton </span> <span>
		...
		<header>
			...
			<h2>
				<small>List Faculty</small>
			</h2>
			<h3>
				<small>List all faculty currently in this system</small>
			</h3>
		</header>
		<form class="form-horizontal">
			<div class="container-fluid">
				...
				<div class="">
					Legend: <i class="icon-list-alt"></i> = Responsibility <i
						class="icon-time"></i> = Complimentary Hours <i class="icon-book"></i>
					= Course <i class="icon-edit"></i> = Update <i class="icon-trash"></i>
					= Delete
				</div>
							...
							<tbody>
								<c:forEach items="${allFaculty }" var="faculty">
									<tr>
										...
										<td><label><a href="#">${faculty.getFacultyFirstName()}
													${faculty.getFacultyLastName() }</a></label></td>
										<td class="align"><a class="bootstrap-tooltip"
											data-original-title="Complimentary Hours"
											data-placement="top" href="Anil_ManageFacultyCompHours.html">
												<i class="icon-time"></i>
										</a> <a class="bootstrap-tooltip"
											data-original-title="Responsibility"
											href="Anil_ManageFacultyResponsibilities.html"><i
												class="icon-list-alt"></i></a> <a class="bootstrap-tooltip"
											data-original-title="Courses"
											href="Anil_ManageFacultyCourses.html"> <i
												class="icon-book"></i>
										</a> <a class="bootstrap-tooltip" data-original-title="Update"
											href="updateFaculty.html"><i class="icon-edit"></i></a> <a
											class="bootstrap-tooltip" data-original-title="Delete"
											onclick="deleteFaculty('${users.getUserId() }', ' ${faculty.getFacultyFirstName()}  ${faculty.getFacultyLastName() } ')"><i
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="myModalLabel">Set User
							Permissions</h4>
					</div>
					<div class="modal-body">
						<!--  FORM ADD -->
